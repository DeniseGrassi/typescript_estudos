...
const colegas: string[] = ['lucas', 'pietro', 'beatriz'] 
...
const notas: ReadonlyArray<number> = [5, 6, 7, 8]
...
const lista: [nome:string, estaEstudando:boolean, idade:number ] = ['denise', true, 33]

// agora faremos com o tipo UNION TYPES: uniao de tipos! com o simbolo | add um novo tipo, no caso o string
let idadeDaAna: number | string = '25 anos';
